...
odds_ratio_ggplot <- subset_to_plot  %>%
    ...
    scale_fill_gradient2(high = "coral3", low = "deepskyblue3", mid = "white", name=str_wrap("Odds Ratio Score", width=15)) + 
    scale_color_manual(values = c( "coral3", "deepskyblue3"), name = "Direction") +
    scale_size_continuous( name = expression( '-log'[10]*'(adj. p-value)') ) +
...
```{r}
ggsave ( filename = file.path( compare_go_terms_results_dir, "compare_s_cerevisiae_c_neoformans_go_terms.png"),  width= 10,  height = 12 )
ggsave ( filename = file.path( compare_go_terms_results_dir, "compare_s_cerevisiae_c_neoformans_go_terms.pdf"),  width= 10,  height = 12 )
ggsave ( filename = file.path( compare_go_terms_results_dir, "compare_s_cerevisiae_c_neoformans_go_terms.tiff"), width= 10,  height = 12 )
