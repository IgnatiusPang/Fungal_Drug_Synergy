...
base_results_dir <-   base::get(command_line_args[2] ) # file.path( results_directory, "Differential_Expression/EdgeR_RUVs_QL/cneo/To_Use_k_5_Remove_5a" ) 
...
# No need to change this parameter
go_terms_results_dir <- file.path( results_directory, "Functional_Enrichment", de_method_label,"GOStat")

# No need to change this parameter
create_directory_if_not_exists(go_terms_results_dir)
