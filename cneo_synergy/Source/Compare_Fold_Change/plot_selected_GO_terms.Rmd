...
seleted_go_terms_fdr <- go_terms_A_specfic %>%
                            ...
                            mutate( Groups = case_when ( query_list_id == "compare_A_specific.up" ~ 'AMB treatment sepcific, up',
                                                         query_list_id == "compare_A_specific.down" ~ 'AMB treatment sepcific, down',
                                                         query_list_id == "compare_AL_specific.up" ~ 'AMB+LF treatment sepcific, up',
                                                         query_list_id == "compare_AL_specific.down" ~ 'AMB+LF treatment sepcific, down',
                                                         TRUE ~ NA_character_
                                                         )) %>%
                            mutate( Groups = factor(Groups, levels = c( 'AMB treatment sepcific, up',
                                                                        'AMB treatment sepcific, down',
                                                                        'AMB+LF treatment sepcific, up',
                                                                        'AMB+LF treatment sepcific, down'))) %>%
