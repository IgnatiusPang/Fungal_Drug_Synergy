...
compare_k_results_output_dir <- file.path ( results_directory, "Differential_Expression/Compare_k", specific_variation)

create_directory_if_not_exists(compare_k_results_output_dir)
