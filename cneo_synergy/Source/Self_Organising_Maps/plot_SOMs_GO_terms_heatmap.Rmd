...
soms_go_results <- read_tsv( file.path(results_dir, "Self_Organising_Maps/EdgeR_RUVs_QL/To_Use_k_0_Remove_5a/Condition_on_child_terms_true/compare_AL/5x5/enriched_go_terms_SOMs.txt"))
