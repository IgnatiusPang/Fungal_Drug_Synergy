...
```{r}
sgd_feature_table <-  read.table( file.path(data_directory, "SGD/SGD_features.tab"), sep="\t", stringsAsFactors = FALSE, quote = "", header=FALSE  )
...
## SGD GO
```{r}
sgd_go <- read.table(file.path( data_directory, "SGD/Gene_Ontology/gene_association.sgd"  ), sep="\t",
