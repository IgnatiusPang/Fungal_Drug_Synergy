...
scer_compare_compare_A_som <- run_soms_analysis( scer_compare_A_data_matrix, "scer", expt_label, 5, 5, results_dir_soms, my_som_random_number_seed )
...
write.table (compare_A_soms_de, paste( results_dir_soms, "som_clusters_compare_A_scer.txt", sep="")  )
```
...
save(cluster_for_each_gene_AMB_only,
          file=paste(results_dir,  "edgeR_scer_SOMs_results_AMB_only_AMB_n_LF.Rdata", sep="") )
```
