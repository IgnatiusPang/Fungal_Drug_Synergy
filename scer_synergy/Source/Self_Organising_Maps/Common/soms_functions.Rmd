...
Date:                 18 April 2016
```{r run1, echo=TRUE, message=FALSE, warning=FALSE}
...
#load( paste(results_directory, "edgeR_scer_compare.Rdata", sep="") )
...
```{r run2, echo=TRUE, message=FALSE, warning=FALSE}
library(kohonen)
library(lattice)
```
...
```{r run3, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r run4, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r run5, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r run6, echo=TRUE, message=FALSE, warning=FALSE}

draw_soms_xyplot_pdf <- function ( som_data_pivot,  som_size_x, som_size_y, results_directory ) { 
	my_pdf_file <- file.path(results_directory, paste("SOMs_", som_size_x, "_by_", som_size_y, ".pdf", sep="")) 
...
### Session Information
```{r run7, echo=TRUE, message=FALSE, warning=FALSE}
sessionInfo()
```
