...
EdgeR_RUVs_QL_de_genes_dir <- file.path( results_directory, "Differential_Expression/EdgeR_RUVs_QL/scer", results_to_use_dir)
...
go_dictionary <- get_crypto_go_dictionary_of_choice  ( "Saccharomyces cerevisiae", gene_ontology_directory, 
...
```{r}
gene_annotation_table <- read_tsv( file.path( data_directory, "Gene_Annotation/scer_gene_annotation_summary.txt"  ) )
